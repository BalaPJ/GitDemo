...
#Checking product names are correct
product_list = ["Cucumber - 1 Kg", "Raspberry - 1/4 Kg", "Strawberry - 1/4 Kg"]

products = driver.find_elements(By.CSS_SELECTOR,"div[class='products'] div[class='product'] h4[class='product-name']")
listed = []

for product in products:
    listed.append(product.text)

print(listed)
print(product_list)

assert listed == product_list
